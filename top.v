...
wire[ADDR_BITS - 1:0]           L2_wr_burst_addr;
...
wire                            video_clk5x;       //video pixel clock 5x
wire                            hs;
wire                            vs;
wire                            de;
wire[15:0]                      vout_data;
...
wire                            hdmi_de;        
wire[7:0]                       hdmi_r;         //hdmi red
wire[7:0]                       hdmi_g;         //hdmi green
wire[7:0]                       hdmi_b;         //hdmi blue
//wire[7:0]                       sobel_out;
wire   [CLASSF_RESULT-1:0]      classfication_result;
assign hdmi_hs = ycbcr_hs;
assign hdmi_vs = ycbcr_vs;
assign hdmi_de = ycbcr_de;
assign hdmi_r  = {vout_data[15:11],3'b000};
assign hdmi_g  = {vout_data[10:5],2'b00};
assign hdmi_b  = {vout_data[4:0],3'b000};
...
neural_networks_top neural_networks_top_inst
(
	.pclk						(video_clk				   ),
    .rst						(~rst_n					   ),	
    .de							(ycbcr_de				   ),
    .pixel_in					(ycbcr_y				   ),
    .classfication_result       (classfication_result	   )          
);
